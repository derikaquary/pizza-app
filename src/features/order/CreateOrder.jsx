      ...
      <Form method="POST">
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          {!position.latitude && !position.longitude && (
            <span className="absolute right-[3px] top-[35.2px] z-50 sm:top-[3px] md:right-1 md:top-[4.5px]">
              <Button
                disabled={isLoadingAddress}
                type="small"
                onClick={(e) => {
...
export async function action({ request }) {
  ...
  //if everything is okay then create newOrder and redirect
...
/* right-[3px] top-[35.2px] sm:top-[3px] */
